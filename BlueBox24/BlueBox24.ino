...
#define API_KEY "insira-aqui-o-API-token"
...
void Oitavas1(){
  ...
  u8g2.setCursor(45,18);
  u8g2.print(jogo49_home[50]);
  u8g2.print("x");
  u8g2.print(jogo49_away[50]);
  u8g2.setCursor(45,27);
  u8g2.print(jogo50_home[50]);
  u8g2.print("x");
  u8g2.print(jogo50_away[50]);
  u8g2.setCursor(45,36);
  u8g2.print(jogo51_home[50]);
  u8g2.print("x");
  u8g2.print(jogo51_away[50]);
  u8g2.setCursor(45,45);
  u8g2.print(jogo52_home[50]);
  u8g2.print("x");
  u8g2.print(jogo52_away[50]);
  u8g2.setCursor(45,54);
  u8g2.print(jogo53_home[50]);
  u8g2.print("x");
  u8g2.print(jogo53_away[50]);
  u8g2.setCursor(45,63);
  u8g2.print(jogo54_home[50]);
  u8g2.print("x");
  u8g2.print(jogo54_away[50]);
...
void Oitavas2(){
  ...
  u8g2.setCursor(45,18);
  u8g2.print(jogo55_home[50]);
  u8g2.print("x");
  u8g2.print(jogo55_away[50]);
  u8g2.setCursor(45,27);
  u8g2.print(jogo56_home[50]);
  u8g2.print("x");
  u8g2.print(jogo56_away[50]);
...
void Quartas(){
  ...
  u8g2.setCursor(45,18);
  u8g2.print(jogo57_home[50]);
  u8g2.print("x");
  u8g2.print(jogo57_away[50]);
  u8g2.setCursor(45,27);
  u8g2.print(jogo58_home[50]);
  u8g2.print("x");
  u8g2.print(jogo58_away[50]);
  u8g2.setCursor(45,36);
  u8g2.print(jogo59_home[50]);
  u8g2.print("x");
  u8g2.print(jogo59_away[50]);
  u8g2.setCursor(45,45);
  u8g2.print(jogo60_home[50]);
  u8g2.print("x");
  u8g2.print(jogo60_away[50]);
...
void SemiFinal(){
  ...
  u8g2.setCursor(45,18);
  u8g2.print(jogo61_home[50]);
  u8g2.print("x");
  u8g2.print(jogo61_away[50]);
  u8g2.setCursor(45,27);
  u8g2.print(jogo62_home[50]);
  u8g2.print("x");
  u8g2.print(jogo62_away[50]);
  u8g2.setCursor(45,54);
 
  u8g2.setCursor(72,18);
  u8g2.print("12/12 16:00");
  u8g2.setCursor(72,27);
...
void TerceiroLugar(){
  ...
  u8g2.setCursor(45,18);
  u8g2.print(jogo63_home[50]);
  u8g2.print("x");
  u8g2.print(jogo63_away[50]);
...
void Final(){
  ...
  u8g2.setCursor(45,18);
  u8g2.print(jogo64_home[50]);
  u8g2.print("x");
  u8g2.print(jogo64_away[50]);
...
void updateJogo1(){
  ...
  serializeJsonPretty(score_home, jogo1_home);
  ...
  serializeJsonPretty(score_away, jogo1_away);
}
...
void updateJogo48(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo48_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo48_away);
}
...
void updateJogo49(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo49_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo49_away);
}
...
void updateJogo50(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo50_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo50_away);
}
...
void updateJogo51(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo51_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo51_away);
}
...
void updateJogo52(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo52_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo52_away);
}
...
void updateJogo53(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo53_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo53_away);
}
...
void updateJogo54(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo54_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo54_away);
}
...
void updateJogo55(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo55_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo55_away);
}
...
void updateJogo56(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo56_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo56_away);
}
...
void updateJogo57(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo57_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo57_away);
}
...
void updateJogo58(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo58_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo58_away);
}
...
void updateJogo59(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo59_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo59_away);
}
...
void updateJogo60(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo60_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo60_away);
}
...
void updateJogo61(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo61_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo61_away);
}
...
void updateJogo62(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo62_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo62_away);
}
...
void updateJogo63(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo63_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo63_away);
}
...
void updateJogo64(){
  ...
  StaticJsonDocument<400> score_home;
  deserializeJson(score_home, payload, DeserializationOption::Filter(filterH));
  serializeJsonPretty(score_home, jogo64_home);
  
  StaticJsonDocument<200> filterA;
  filterA["score"]["fullTime"]["away"] = true;
  StaticJsonDocument<400> score_away;
  deserializeJson(score_away, payload, DeserializationOption::Filter(filterA));
  serializeJsonPretty(score_away, jogo64_away);
}
